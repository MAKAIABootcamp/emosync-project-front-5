...
export const swals = (type, navigate = null) => {
    switch (type) {
        ...
        case "REPORT-APPOINTMENTS":
            Swal.fire(
                'Excelente!',
                'Tu cita ha sido reportada con exito, gracias por tomarte el tiempo de reportarlo!',
                'success'
            )
            break;
        ...
        case "CONFIRM-APPOINTMENT":
            Swal.fire(
                'Excelente!',
                'Tu cita ha sido agendada con exito, ¡gracias por utilizar nuestro servicio! Se te notificará en caso de que la cita que agendaste sea confirmada o por el contrario rechazada.',
                'success'
            )
            break;
